function User(nickname,correo,type,name,online,points,age,lasttime,createby,createTime,picProfile,pictures,picturesp,country,region,languange,sex,
  seeking,boxs,codigo,state,bodytype,haircolor,eyecolor,height,weight,smoker,alcohol,describe,verificarDataUser){
  ...
  this.verificarDataUser = verificarDataUser ? verificarDataUser: false;
}
